...
def websocket_instrument_data() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"symbol": "KJMCFIN","exchange_id": 2,"data_provider_id": 2,"token": "BSE_EQ|INE533C01018","name": "KJMC FINoneCIAL SERVICES LTD.","instrument_type": "EQ","expiry_date": None,"strike_price": None,"lot_size": 1,"tick_size": 5.0,},
        {"symbol": "LERTHAI","exchange_id": 2,"data_provider_id": 2,"token": "BSE_EQ|INE347D01011","name": "LERTHAI FINoneCE LIMITED","instrument_type": "EQ","expiry_date": None,"strike_price": None,"lot_size": 1,"tick_size": 5.0,},
